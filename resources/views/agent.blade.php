    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white p-4 rounded-lg shadow">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-bold">My Clients</h2>
                <a href="{{ route('agent.create.client.form') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-sm">Add Client</a>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    {{ $client->tank && $client->tank->status === 'active' ? 'bg-green-100 text-green-800' : 
                                       ($client->tank && $client->tank->status === 'maintenance' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800') }}">
            ...
            <div class="mt-4 text-right">
                <a href="{{ route('agent.clients') }}" class="text-blue-500 hover:underline">View all clients</a>
            </div>
        </div>
